...
export class Log {
  ...
  debug(...args: unknown[]): void {
    ...
    console.log(
      `%c ${this.appName} `,
      `color: ${debug.color};background-color: ${debug.bgColor}; font-size:${debug.fontSize};`,
      ...args
    )
    // #endif
  ...
  log(...args: unknown[]): void {
    ...
    console.log(
      `%c ${this.appName} `,
      `color: ${log.color};background-color: ${log.bgColor}; font-size:${log.fontSize};`,
      ...args
    )
    // #endif
  ...
  warn(...args: unknown[]): void {
    ...
    console.warn(
      `%c ${this.appName} `,
      `color: ${warn.color};background-color: ${warn.bgColor}; font-size:${warn.fontSize};`,
      ...args
    )
    // #endif
  ...
  error(...args: unknown[]): void {
    ...
    console.error(
      `%c ${this.appName} `,
      `color: ${error.color};background-color: ${error.bgColor}; font-size:${error.fontSize};`,
      ...args
    )
    // #endif

 ...
 * @returns { WordArray }
 */
export declare function encryptAES(data: string | CryptoJS.LibWordArray, key: string, cfg?: CryptoJS.CipherOption | undefined): WordArray;
/**
 * AES 加密输出 base64
 * @param { string } data - 需要加密的数据
 * @param { string } key - 需要加密的密码
 ...
 */
export declare function encryptAES2Base64(data: string | CryptoJS.LibWordArray, key: string, cfg?: CryptoJS.CipherOption | undefined): string;
/**
 * AES 加密输出 hex
 * @param { string } data - 需要加密的数据
 * @param { string } key - 需要加密的密码
 ...
 * @returns { string } - 输出的结果
 */
export declare function encryptAES2HexString(data: string | CryptoJS.LibWordArray, key: string, cfg?: CryptoJS.CipherOption | undefined): string;
/**
 * AES 解密
 ...
 */
export declare function decryptAES(data: string | WordArray, key: string, cfg?: CryptoJS.CipherOption | undefined): DecryptedMessage;
/**
 * AES 解密 base64
 ...
 * @returns { string } - 解密的数据
 */
export declare function decryptBase64AES2String(data: string, key: string, cfg?: CryptoJS.CipherOption | undefined): string;
/**
 * AES 解密 hex
 * @param { string } data - 需要解密的数据
 * @param { string } key - 需要解密的密码
 ...
 */
export declare function decryptHexAES(data: string, key: string, cfg?: CryptoJS.CipherOption | undefined): DecryptedMessage;
/**
 * AES 解密 hex
 * @param { string } data - 需要解密的数据
 * @param { string } key - 需要解密的密码
...
export declare function getRSAEnCryptor(options: IJSEncryptOptions | undefined, initOptions?: GetRSAEnCryptorOptions): JSEncrypt;
/**
 * RSA 加密
 * @param { string } data - 需要加密的数据
